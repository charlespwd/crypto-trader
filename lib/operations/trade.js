...
function successfulResponse(isBuying, amount, total, rate) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, isBuying ? amount : total];
        });
    });
}
// Scenarios
...
function trade(api, fromAmount, fromCoin, toCoin, currencyPair, n) {
    if (n === void 0) { n = 0; }
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    tradeFn = isBuying ? api.buy : api.sell;
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 7, , 9]);
                ...
                case 2:
                    tickers = _b.sent();
                    rate = getRate(api, isBuying, currencyPair, tickers);
                ...
                case 3:
                    _a = _b.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, utils_1.enqueue(R.partial(successfulResponse, [isBuying, amount, total, rate]))];
                case 5:
                    _a = _b.sent();
                    _b.label = 6;
                ...
                case 8:
                    _b.sent();
                    return [2 /*return*/, trade(api, fromAmount, fromCoin, toCoin, currencyPair, n + 1)];
